...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_dependency(%q<cucumber-gherkin>.freeze, ["< 33.0"])
    s.add_dependency(%q<bundler>.freeze, ["< 3.0"])
    s.add_dependency(%q<childprocess>.freeze, ["< 6.0"])
    s.add_dependency(%q<cucumber>.freeze, [">= 4.0.0", "< 10.0.0"])
    s.add_dependency(%q<rainbow>.freeze, ["< 4.0.0"])
    s.add_dependency(%q<rake>.freeze, ["< 14.0.0"])
    ...
    s.add_dependency(%q<test-unit>.freeze, ["< 4.0.0"])
