(function () {
  ...
  function selectVersion() {
    stable = "/openhab-jruby/" + stable_version + "/";
    main = "/openhab-jruby/main/";
    if (document.location.pathname.startsWith(main) ||
      document.location.pathname.startsWith("/docs/") ||
      document.location.protocol === "file:") {
      $(".version-button.main").toggleClass("current");
    } else if (document.location.pathname.startsWith(stable)) {
      $(".version-button.stable").toggleClass("current");
    }
    path = document.location.pathname.replace(/^\/openhab-jruby\/.+?\//, "");
    $(".version-button.stable").attr("href", stable + path);
    $(".version-button.main").attr("href", main + path);
  }
