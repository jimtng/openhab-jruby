      ...
      class ZonedDateTime
        ...
        def -(other)
          if other.respond_to?(:to_zoned_date_time)
            return java.time.Duration.between(other.to_zoned_date_time, self)
          elsif other.is_a?(Numeric)
            other = other.seconds
          elsif other.is_a?(QuantityType) && other.unit.compatible?(Units::SECOND)
            other = Duration.of_nanos(other.to_unit("ns").to_i)
          end
        ...
        def +(other)
          ...
          if other.is_a?(QuantityType) && other.unit.compatible?(Units::SECOND)
            other = Duration.of_nanos(other.to_unit("ns").to_i)
          end
